/* A000020 number of primitive polynomials of degree n over GF(2),
   ...
   - quadratic sieve (simple variant)
   - (more to come later, qs will be improved)
